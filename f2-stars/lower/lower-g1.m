...
costSplit[pa2_,pb2_,pc1_,pc2_] := {
    ...
    Cf1[d1a2c1,d2a2c1,pa2,pc1,pb2*g + (1-pb2)*1],
    Cf1[d1a2c2,d2a2c2,pa2,pc2,pb2*g + (1-pb2)*1]
}
...
{b0,g0,gammaA0,gammaC0}={b,g,gammaA2,gammaC2}/.solNLP;
...
sol2 = SolveLPatSol[{b->pb,gammaA2->pgammaA,gammaC2->pgammaC,g->pg},algsI(*,constrD1D2*)];
Column@{Grid@{{"Closed form",#,N@#}&[exactSolutionForm/.sol2],{"LP sol",#,N@#}&[Z/.sol2]},sol2,EvaluateAlgsByMass[sol2,algsI]}
],{{pb,b0},0,1,1/1000},{{pgammaA,gammaA0},1/1000,3/2,1/1000},{{pgammaC,gammaC0},1/1000,1,1/1000},{{pg,g0},1/1000,1,1/1000}]//N
